...
#
# Format: YAML-ähnliche Blöcke, getrennt durch ---
# Felder pro Phase: num, title, time, instruction, guide (Zeilen mit -)
# Anker-Texte am Ende unter ## ANKER
...
instruction: Drei diagnostische Fragen. Jede öffnet eine andere Ebene. Lass Pausen zu — die wichtigsten Antworten kommen nach der ersten Stille.
...
instruction: Fasse zusammen, was du gehört hast. Kein Rat. Kein Framework. Nur ein Spiegel. Der Mensch soll sich gehört fühlen — nicht analysiert.
...
- Mein Selbstwert hängt nicht von NELION ab.
